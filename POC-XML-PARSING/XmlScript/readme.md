since apache beam do not have any inbuilt function to directly read an xml file format so I created a script which will convert the xml file to dictionary, 
